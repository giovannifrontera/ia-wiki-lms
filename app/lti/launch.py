...
class _InMemorySessionService(SessionService):
    """Session backed by a plain dict (single-request scope)."""

    def __init__(self, request: _FastApiRequest):
        self._store: dict = {}
...
class FastApiMessageLaunch(MessageLaunch):
    ...
    async def from_request(
        ...
        session_svc = _InMemorySessionService(lti_request)
